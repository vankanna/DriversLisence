...
public class FirstNameUtility {
    final private Map<String, Integer> firstNameCodeMap = new HashMap<>();
    final private Map<String, Integer> firstInitialCodeMap = new HashMap<>();
    final private Map<String, Integer> middleInitialCodeMap = new HashMap<>();
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        if (middleInitial != null && !middleInitial.equals("")) {
            mi = middleInitialCodeMap.get(middleInitial);
        } else {
            mi = 0;
        }
        if(firstName == null || firstName.isEmpty()){
            ...
            if(firstNameCodeMap.containsKey(firstName)) {
                return firstNameCodeMap.get(firstName) + mi;
            } else {
                return firstInitialCodeMap.get(Character.toString(Character.toUpperCase(firstName.charAt(0)))) + mi;
            }
        }
